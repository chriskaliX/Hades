...
impl Client {
    ...
    pub fn send_record(&mut self, rec: &Record) -> Result<(), Error> {
        ...
        #[cfg(feature = "debug")]
        {
            // In Hades, a record always set into field "data"
            // For debug, we DO NOT show the data_type and timestamp fields
            let fields = rec.get_data().get_fields();
    ...
    pub fn enable_updater(&mut self, mills: u64) -> Result<Updater, std::io::Error>{
