#ifndef __RUNTIME_TASK_HELPERS_H__
#define __RUNTIME_TASK_HELPERS_H__
...
static __noinline void *get_path(struct path *path)
{
    struct path f_path;
...
static __noinline void *get_fd(struct task_struct *task, u64 num)
{
...
static __always_inline bool is_arm64_compat(struct task_struct *task)
{
    ...
    return READ_KERN(task->thread_info.flags) & TIF_32BIT;
#else
    return false;
#endif
}
