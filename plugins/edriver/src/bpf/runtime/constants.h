#ifndef __RUNTIME_CONSTANTS_H__
#define __RUNTIME_CONSTANTS_H__
...
#define MAX_PATH_COMPONENTS         (12)
#define MAX_PATH_COMPONENTS_SIM     (8)
#define MAX_NODENAME                (64)
#define MAX_PID_TREE_TRACE          (8)
#define MAX_STR                     (4096)
...
#define TIF_32BIT                   (1U << 22) /* arm64 compat task flag */
